...
static func get_type_string(type: int) -> String:
    match type:
        ...
        TYPE_MAX:
            return "TYPE_MAX"
        _:
            push_error("Utils.get_type_string: %d" % type)
            return ""
